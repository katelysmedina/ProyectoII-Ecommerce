  ...
  const [productsByCategory, setProductsByCategory] = useState({
    Ropa: {
      'Cazadoras y abrigos': [
        ...
        { id: 5, name: 'Parka oversized', category: 'Ropa', subcategory: 'Cazadoras y abrigos', price: 1099.00, image: [require('../assets/img/CHA1_1.jpeg'), require('../assets/img/CHA1_2.jpeg'), require('../assets/img/CHA1_3.jpeg'), require('../assets/img/CHA1_4.jpeg'), require('../assets/img/CHA1_5.jpeg')], color:'Negro', characteristics: ['Parka oversized en sarga de algodón. Cuello de cisne, zíper y solapa de viento con botones de presión ocultos al frente. Cordón de ajuste en la cintura y bolsillos al frente.'], sizes: ['XCH', 'CH', 'M', 'G', 'XG']  },
        { id: 6, name: 'Chamarra efecto piel', category: 'Ropa', subcategory: 'Cazadoras y abrigos', price: 1249.00, image: [require('../assets/img/CHA2_1.jpeg'), require('../assets/img/CHA2_2.jpeg'), require('../assets/img/CHA2_3.jpeg'), require('../assets/img/CHA2_4.jpeg'), require('../assets/img/CHA2_5.jpeg')], color:'Negro', characteristics: ['Chamarra efecto piel de corte amplio. Cuello cisne con trabilla y botón de presión. Zíper al frente y oculto. Bolsillos de sobre al frente.'], sizes: ['XCH', 'CH', 'M', 'G', 'XG']   }, 
      ],

    Blazers: [
        { id: 7, name: 'Blazer de lana con cinturón', category: 'Ropa', subcategory: 'Blazers', price: 899.00, image: [require('../assets/img/BLA1_1.jpeg'), require('../assets/img/BLA1_2.jpeg'), require('../assets/img/BLA1_3.jpeg')], color:'Gris', characteristics: ['Blazer de botonadura sencilla en lana. Corte amplio y cinturón de lazo extraíble a la cintura. Bolsillos frontales discretos. Forrado.'], sizes: ['XCH', 'CH', 'M', 'G', 'XG']   },
        { id: 8, name: 'Blazer oversized con botondura doble', category: 'Ropa', subcategory: 'Blazers', price: 899.00, image: [require('../assets/img/BLA2_1.jpeg'), require('../assets/img/BLA2_2.jpeg'), require('../assets/img/BLA2_3.jpeg'), require('../assets/img/BLA2_4.jpeg') ], color:'Beige', characteristics: ['Blazer oversized de botonadura doble. Corte amplio con hombreras. Bolsillos frontales discretos. Forrado. '], sizes: ['XCH', 'CH', 'M', 'G', 'XG'] },
        { id: 9, name: 'Blazer de lana con botonadura sencilla', category: 'Ropa', subcategory: 'Blazers', price: 899.00, image: [require('../assets/img/BLA3_1.jpeg'), require('../assets/img/BLA3_2.jpeg'), require('../assets/img/BLA3_3.jpeg'), require('../assets/img/BLA3_4.jpeg') ], color:'Café/Cuadros', characteristics: ['Blazer de botonadura sencilla en lana. Corte ajustado con pinzas. Bolsillos frontales de solapa. Forrado.'], sizes: ['XCH', 'CH', 'M', 'G', 'XG'] },
    ...
    Pantalones: [
        ...
        { id: 26, name: 'Pantalón de vestir efecto piel', category: 'Ropa', subcategory: 'Pantalones', price: 999.00, image: [require('../assets/img/PAN4_1.jpeg'), require('../assets/img/PAN4_2.jpeg'), require('../assets/img/PAN4_3.jpeg')], color:'Negro', characteristics: ['Pantalón de corte amplio efecto piel. Modelo de talle alto con cierre de zíper y botón. Piernas anchas de corte recto con bolsillos laterales y traseros.'], sizes: ['XCH', 'CH', 'M', 'G', 'XG'] },

    ],

    Suéteres: [
        { id: 27, name: 'Suéter tejido cuello alto', category: 'Ropa', subcategory: 'Suéteres', price: 649.00, image: [require('../assets/img/SUE1_1.jpeg'), require('../assets/img/SUE1_2.jpeg'), require('../assets/img/SUE1_3.jpeg'), require('../assets/img/SUE1_4.jpeg') ], color:'Bronce', characteristics: ['Suéter de corte amplio en tejido acanelado. Modelo de cuello alto con hombros caídos y abertura en cuello posterior.'], sizes: ['XCH', 'CH', 'M', 'G', 'XG'] },
        { id: 28, name: 'Suéter cuello alto', category: 'Ropa', subcategory: 'Suéteres', price: 599.00, image: [require('../assets/img/SUE2_1.jpeg'), require('../assets/img/SUE2_2.jpeg'), require('../assets/img/SUE2_3.jpeg'), require('../assets/img/SUE2_4.jpeg') ], color:'Verde', characteristics: ['Suéter en tejido suave y fino. Modelo de corte amplio con cuello alto y hombros caídos. Borde acanelado en cuello, puños y bastilla.'], sizes: ['XCH', 'CH', 'M', 'G', 'XG'] },
        { id: 29, name: 'Suéter cuello alto', category: 'Ropa', subcategory: 'Suéteres', price: 599.00, image: [require('../assets/img/SUE3_1.jpeg'), require('../assets/img/SUE3_2.jpeg'), require('../assets/img/SUE3_3.jpeg'), require('../assets/img/SUE3_4.jpeg') ], color:'Negro', characteristics: ['Suéter en tejido suave y fino. Modelo de corte amplio con cuello alto y hombros caídos. Borde acanelado en cuello, puños y bastilla.'], sizes: ['XCH', 'CH', 'M', 'G', 'XG'] },
        
    ],

    Tops: [
        { id: 30, name: 'Top en tejido acanelado', category: 'Ropa', subcategory: 'Tops', price: 449.00, image: [require('../assets/img/TOP1_1.jpeg'), require('../assets/img/TOP1_2.jpeg'), require('../assets/img/TOP1_3.jpeg'), require('../assets/img/TOP1_4.jpeg') ], color:'Azul', characteristics: ['Top ajustado en tejido acanelado. Manga larga con abertura pronunciado en la parte frontal lateral.'], sizes: ['XCH', 'CH', 'M', 'G', 'XG'] },
    ...
    Calzado: {
    Balerinas: [
        { id: 38, name: 'Balerinas Mary Jane', category: 'Calzado', subcategory: 'Balerinas', price: 599.00, image: [require('../assets/img/BAL1_1.jpeg'), require('../assets/img/BAL1_2.jpeg'), require('../assets/img/BAL1_3.jpeg')], color:'Negro', characteristics: ['Balerinas con diseño Mary Jane. Modelo con frente cuadrado y correa gruesa con hebilla de metal.'], sizes: ['XCH', 'CH', 'M', 'G', 'XG'] },
        { id: 39, name: 'Balerinas Mary Jane', category: 'Calzado', subcategory: 'Balerinas', price: 599.00, image: [require('../assets/img/BAL2_1.jpeg'), require('../assets/img/BAL2_2.jpeg'), require('../assets/img/BAL2_3.jpeg')], color:'Plateado', characteristics: ['Balerinas con diseño Mary Jane. Modelo con frente cuadrado y correa gruesa con hebilla de metal.'], sizes: ['XCH', 'CH', 'M', 'G', 'XG'] },
        { id: 40, name: 'Balerinas en malla', category: 'Calzado', subcategory: 'Balerinas', price: 799.00, image: [require('../assets/img/BAL3_1.jpeg'), require('../assets/img/BAL3_2.jpeg'), require('../assets/img/BAL3_3.jpeg'), ], color:'Rojo', characteristics: ['Balerinas Mary Jane en malla y tela revestida con un acabado metálico brillante. Punta cincelada y doble correa estrella con hebilla de metal.'], sizes: ['XCH', 'CH', 'M', 'G', 'XG'] },
    ],

    Loafers: [
      { id: 41, name: 'Loafers de suela gruesa', category: 'Calzado', subcategory: 'Loafers', price: 699.00, image: [require('../assets/img/LOA1_1.jpeg'), require('../assets/img/LOA1_2.jpeg') ], color:'Negro', characteristics: ['Mocasines con trabilla decorativa al frente. Forro de satín. Altura de las suelas de 4 cm.'], sizes: ['XCH', 'CH', 'M', 'G', 'XG'] },
    ],

    Botas: [
      { id: 42, name: 'Botas tacón ancho', category: 'Calzado', subcategory: 'Botas', price: 839.00, image: [require('../assets/img/BOT1_1.jpeg'), require('../assets/img/BOT1_2.jpeg'), require('../assets/img/BOT1_3.jpeg') ], color:'Café oscuro', characteristics: ['Botas de tela afieltrada con frente cuadrado. Tacón cuadrado de 4 cm. Forro de punto y plantillas de piel.'], sizes: ['XCH', 'CH', 'M', 'G', 'XG']},
      { id: 43, name: 'Botas punta fina con tacón dorado', category: 'Calzado', subcategory: 'Botas', price: 969.00, image: [require('../assets/img/BOT2_1.jpeg'), require('../assets/img/BOT2_2.jpeg'), require('../assets/img/BOT2_3.jpeg')], color:'Negro', characteristics: ['Botas de piel con frente en punta y tacón con detalle. Forro y plantillas de punto.'], sizes: ['XCH', 'CH', 'M', 'G', 'XG'] },
    ],

    Zapatillas: [
      { id: 44, name: 'Zapatillas kitten destalonado', category: 'Calzado', subcategory: 'Zapatillas', price: 499.00, image: [require('../assets/img/ZAP1_1.jpeg'), require('../assets/img/ZAP1_2.jpeg') ], color:'Negro', characteristics: ['Zapatillas de piel. Modelo con frente en punta y correa cruzada y en el tobillo. Tacón fino de 5 cm.'], sizes: ['XCH', 'CH', 'M', 'G', 'XG'] },
      { id: 45, name: 'Mary Jane tacón ancho', category: 'Calzado', subcategory: 'Zapatillas', price: 559.00, image: [require('../assets/img/ZAP2_1.jpeg'), require('../assets/img/ZAP2_2.jpeg')], color:'Negro', characteristics: ['Mary Janes en piel. Frente cuadradi y tacón de bloque forrado. Corres ajustables con hebillas de metal. Plantillas de piel.'], sizes: ['XCH', 'CH', 'M', 'G', 'XG'] },
    ],
  },
    Bolsos: [
      { id: 46, name: 'Bolso bandolera efecto piel', category: 'Bolsos', subcategory: '', price: 599.00, image: [require('../assets/img/BOL1_1.jpeg'), require('../assets/img/BOL1_2.jpeg'), require('../assets/img/BOL1_3.jpeg'), ], color:'Borgoña', characteristics: ['Bolso bandolera efecto piel. Modelo con zíper superior y un compartimiento interior con zíper. Correa ajustable. Forrado.'], sizes: ['XCH', 'CH', 'M', 'G', 'XG'] },
      { id: 47, name: 'Bolso bandolera bucket', category: 'Bolsos', subcategory: '', price: 599.00, image: [require('../assets/img/BOL2_1.jpeg'), require('../assets/img/BOL2_2.jpeg')], color:'Negro', characteristics: ['Bolso bucket efecto piel. Asa ajustable con hebillas en los laterales. Cierre oculto magnético. Forrado.'], sizes: ['XCH', 'CH', 'M', 'G', 'XG'] },
      { id: 48, name: 'Bolso bandolera liso', category: 'Bolsos', subcategory: '', price: 699.00, image: [require('../assets/img/BOL3_1.jpeg'), require('../assets/img/BOL3_2.jpeg')], color:'Borgoña', characteristics: ['Bolso bandolera efecto piel. Modelo con solapa y cierre magnético oculto. Un compartimiento interior con zíper y correa ajustable. Forrado. '], sizes: ['XCH', 'CH', 'M', 'G', 'XG'] },
      { id: 49, name: 'Bolso crossbody', category: 'Bolsos', subcategory: '', price: 499.00, image: [require('../assets/img/BOL4_1.jpeg'), require('../assets/img/BOL4_2.jpeg') ], color:'Negro', characteristics: ['Bolso crossbody efecto piel. Modelo con zíper superior y correa ajustable con hebillas de metal. Forrado.'], sizes: ['XCH', 'CH', 'M', 'G', 'XG'] },
